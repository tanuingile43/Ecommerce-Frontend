        ...
        <section className='grid grid-cols  lg:grid-cols-2 px-4 pt-10'>
          ...
          <div className="lg:col-span-1 maxt-auto  max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              ...
              <h1 className="text-lg  lg:text-xl font-semibold text-gray-900 opacity-60 pt-1">Product Title</h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                <p className='font-semibold'>₹ Product Discounted Price </p>
              ...
              <form className="mt-10">
                ...
                <div className="mt-10">
                  ...
                  <p className='border-light border-radius mt-1 w-[5rem] text-white flex items-center justify-center p-1 bg-slate-800 :font-semibold'>product color</p>
